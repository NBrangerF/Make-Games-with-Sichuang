...
- 机器规则标出了 951 个可能需要分段或渐进披露的长句、长段与抽象词密集处。这是编辑优先级，不是内容质量评分。
...
| `design-case-ids.json` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/agricola/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/agricola/meta.json` | 6 | 131 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/agricola/zh-CN.md` | 37 | 2358 | 1 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/azul/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/azul/meta.json` | 7 | 128 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/azul/zh-CN.md` | 42 | 2381 | 8 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/cant-stop/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/cant-stop/meta.json` | 6 | 110 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/cant-stop/zh-CN.md` | 38 | 2368 | 7 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/carcassonne/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/carcassonne/meta.json` | 5 | 104 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/carcassonne/zh-CN.md` | 38 | 2386 | 1 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/dominion/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/dominion/meta.json` | 7 | 113 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/dominion/zh-CN.md` | 38 | 2488 | 1 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/el-grande/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/el-grande/meta.json` | 6 | 135 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/el-grande/zh-CN.md` | 44 | 2594 | 6 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/for-sale/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/for-sale/meta.json` | 8 | 124 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/for-sale/zh-CN.md` | 43 | 2255 | 6 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/hanabi/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/hanabi/meta.json` | 6 | 122 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/hanabi/zh-CN.md` | 39 | 2503 | 2 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/modern-art/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/modern-art/meta.json` | 6 | 104 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/modern-art/zh-CN.md` | 43 | 2108 | 4 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/pandemic/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/pandemic/meta.json` | 7 | 119 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/pandemic/zh-CN.md` | 35 | 2314 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/quacks/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/quacks/meta.json` | 7 | 128 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/quacks/zh-CN.md` | 37 | 2541 | 8 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/radlands/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/radlands/meta.json` | 6 | 108 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/radlands/zh-CN.md` | 37 | 2225 | 3 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/root/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/root/meta.json` | 6 | 108 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/root/zh-CN.md` | 47 | 2518 | 2 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/six-nimmt/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/six-nimmt/meta.json` | 7 | 128 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/six-nimmt/zh-CN.md` | 38 | 2072 | 2 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/spirit-island/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/spirit-island/meta.json` | 6 | 111 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/spirit-island/zh-CN.md` | 39 | 2649 | 6 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/the-crew/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/the-crew/meta.json` | 7 | 116 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/the-crew/zh-CN.md` | 46 | 2328 | 8 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/ticket-to-ride/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/ticket-to-ride/meta.json` | 10 | 138 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/ticket-to-ride/zh-CN.md` | 48 | 2947 | 6 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/wingspan/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/wingspan/meta.json` | 8 | 148 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-cases/wingspan/zh-CN.md` | 41 | 2688 | 4 | 支持资料：通过节点或资料库按需进入 |
...
| `design-library/ascending-auction/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/ascending-auction/zh-CN.md` | 34 | 1816 | 6 | 支持资料：通过节点或资料库按需进入 |
| `design-library/asymmetric-powers/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/asymmetric-powers/zh-CN.md` | 34 | 1766 | 4 | 支持资料：通过节点或资料库按需进入 |
...
| `design-library/comparison-collection-combo/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/comparison-collection-combo/zh-CN.md` | 35 | 1805 | 1 | 支持资料：通过节点或资料库按需进入 |
| `design-library/comparison-control-majority/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/comparison-control-majority/zh-CN.md` | 36 | 1866 | 6 | 支持资料：通过节点或资料库按需进入 |
...
| `design-library/comparison-hidden-deduction/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/comparison-hidden-deduction/zh-CN.md` | 35 | 1712 | 1 | 支持资料：通过节点或资料库按需进入 |
| `design-library/comparison-income-loan/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/comparison-income-loan/zh-CN.md` | 35 | 1713 | 2 | 支持资料：通过节点或资料库按需进入 |
...
| `design-library/comparison-shared-team/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/comparison-shared-team/zh-CN.md` | 40 | 2190 | 6 | 支持资料：通过节点或资料库按需进入 |
...
| `design-library/comparison-trade-promise/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/comparison-trade-promise/zh-CN.md` | 32 | 1775 | 1 | 支持资料：通过节点或资料库按需进入 |
...
| `design-library/deduction/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/deduction/zh-CN.md` | 36 | 1780 | 4 | 支持资料：通过节点或资料库按需进入 |
...
| `design-library/investment/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/investment/zh-CN.md` | 35 | 1775 | 1 | 支持资料：通过节点或资料库按需进入 |
...
| `design-library/loans/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/loans/zh-CN.md` | 35 | 1750 | 1 | 支持资料：通过节点或资料库按需进入 |
...
| `design-library/negotiation-commitments/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/negotiation-commitments/zh-CN.md` | 31 | 1800 | 3 | 支持资料：通过节点或资料库按需进入 |
| `design-library/player-elimination/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/player-elimination/zh-CN.md` | 35 | 1822 | 5 | 支持资料：通过节点或资料库按需进入 |
| `design-library/public-private-scoring/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/public-private-scoring/zh-CN.md` | 33 | 1823 | 6 | 支持资料：通过节点或资料库按需进入 |
...
| `design-library/scenario-campaign/zh-CN.md` | 40 | 2393 | 7 | 支持资料：通过节点或资料库按需进入 |
...
| `design-library/sealed-bid-auction/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/sealed-bid-auction/zh-CN.md` | 36 | 1718 | 4 | 支持资料：通过节点或资料库按需进入 |
| `design-library/second-price-auction/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/second-price-auction/zh-CN.md` | 29 | 1644 | 7 | 支持资料：通过节点或资料库按需进入 |
...
| `design-library/solo-opponent/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/solo-opponent/zh-CN.md` | 40 | 2003 | 2 | 支持资料：通过节点或资料库按需进入 |
| `design-library/team-structure/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/team-structure/zh-CN.md` | 34 | 2043 | 4 | 支持资料：通过节点或资料库按需进入 |
...
| `design-library/traitor-structure/en.md` | 0 | 0 | 0 | 支持资料：通过节点或资料库按需进入 |
| `design-library/traitor-structure/zh-CN.md` | 38 | 2314 | 6 | 支持资料：通过节点或资料库按需进入 |
...
| `original-articles/between-your-turns/zh-CN.md` | 22 | 1398 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/beyond-game-labels/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/beyond-game-labels/zh-CN.md` | 21 | 1241 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/catalog.json` | 138 | 2958 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/constraints-that-open-possibilities/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/constraints-that-open-possibilities/zh-CN.md` | 16 | 1045 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/emotion-through-action/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/emotion-through-action/zh-CN.md` | 21 | 1195 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/play-beyond-the-rules/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/play-beyond-the-rules/zh-CN.md` | 22 | 1353 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-access-and-participation/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-access-and-participation/zh-CN.md` | 15 | 876 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-balance-and-player-count/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-balance-and-player-count/zh-CN.md` | 18 | 1056 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-choices-and-agency/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-choices-and-agency/zh-CN.md` | 19 | 998 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-combine-mechanisms/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-combine-mechanisms/zh-CN.md` | 18 | 1014 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-cooperation-and-conflict/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-cooperation-and-conflict/zh-CN.md` | 18 | 1028 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-core-actions/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-core-actions/zh-CN.md` | 18 | 976 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-design-an-economy/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-design-an-economy/zh-CN.md` | 18 | 1105 | 2 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-design-judgment/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-design-judgment/zh-CN.md` | 15 | 757 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-diagnose-feedback/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-diagnose-feedback/zh-CN.md` | 15 | 832 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-first-design-brief/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-first-design-brief/zh-CN.md` | 19 | 987 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-goals-and-pacing/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-goals-and-pacing/zh-CN.md` | 18 | 1055 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
...
| `original-articles/race-observe-a-game/zh-CN.md` | 19 | 991 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-plan-a-playtest/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-plan-a-playtest/zh-CN.md` | 15 | 816 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-players-and-context/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-players-and-context/zh-CN.md` | 19 | 1088 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-prototype-for-a-question/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-prototype-for-a-question/zh-CN.md` | 15 | 796 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-prototypes-and-evidence/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-prototypes-and-evidence/zh-CN.md` | 17 | 849 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-resources-and-endings/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-resources-and-endings/zh-CN.md` | 19 | 1025 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-rules-and-components/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-rules-and-components/zh-CN.md` | 18 | 1012 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-rules-and-play/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-rules-and-play/zh-CN.md` | 19 | 1090 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-share-a-playable-version/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-share-a-playable-version/zh-CN.md` | 15 | 824 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-space-and-opportunity/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-space-and-opportunity/zh-CN.md` | 18 | 1063 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-state-and-resolution/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-state-and-resolution/zh-CN.md` | 19 | 994 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-stories-and-models/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-stories-and-models/zh-CN.md` | 18 | 1041 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-theme-and-emotion/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-theme-and-emotion/zh-CN.md` | 18 | 975 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-time-and-interaction/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/race-time-and-interaction/zh-CN.md` | 18 | 1058 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-access-and-participation/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-access-and-participation/zh-CN.md` | 22 | 1324 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-balance-and-player-count/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-balance-and-player-count/zh-CN.md` | 23 | 1728 | 5 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-choices-and-agency/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-choices-and-agency/zh-CN.md` | 22 | 1415 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-combine-mechanisms/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-combine-mechanisms/zh-CN.md` | 26 | 1645 | 2 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-cooperation-and-conflict/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-cooperation-and-conflict/zh-CN.md` | 22 | 1519 | 2 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-core-actions/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-core-actions/zh-CN.md` | 19 | 1104 | 2 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-design-an-economy/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-design-an-economy/zh-CN.md` | 23 | 1524 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-design-judgment/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-design-judgment/zh-CN.md` | 16 | 1116 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-diagnose-feedback/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-diagnose-feedback/zh-CN.md` | 25 | 1775 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-first-design-brief/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-first-design-brief/zh-CN.md` | 15 | 1030 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-goals-and-pacing/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-goals-and-pacing/zh-CN.md` | 21 | 1461 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-ideas-under-constraints/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-ideas-under-constraints/zh-CN.md` | 16 | 1078 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-independent-rules-test/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-independent-rules-test/zh-CN.md` | 18 | 1237 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-information-and-randomness/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-information-and-randomness/zh-CN.md` | 24 | 1491 | 2 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-observe-a-game/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-observe-a-game/zh-CN.md` | 16 | 1086 | 2 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-plan-a-playtest/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-plan-a-playtest/zh-CN.md` | 16 | 1096 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-players-and-context/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-players-and-context/zh-CN.md` | 19 | 1243 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-prototype-for-a-question/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-prototype-for-a-question/zh-CN.md` | 15 | 1071 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-prototypes-and-evidence/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-prototypes-and-evidence/zh-CN.md` | 19 | 1147 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-resources-and-endings/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-resources-and-endings/zh-CN.md` | 24 | 1597 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-rules-and-components/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-rules-and-components/zh-CN.md` | 22 | 1319 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-rules-and-play/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-rules-and-play/zh-CN.md` | 24 | 1507 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-share-a-playable-version/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-share-a-playable-version/zh-CN.md` | 19 | 1316 | 3 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
...
| `original-articles/reading-state-and-resolution/zh-CN.md` | 17 | 1117 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-stories-and-models/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-stories-and-models/zh-CN.md` | 21 | 1297 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-theme-and-emotion/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-theme-and-emotion/zh-CN.md` | 19 | 1219 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-time-and-interaction/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/reading-time-and-interaction/zh-CN.md` | 21 | 1354 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/rewards-and-reasons/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/rewards-and-reasons/zh-CN.md` | 22 | 1269 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/when-feedback-disagrees/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/when-feedback-disagrees/zh-CN.md` | 19 | 1165 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/when-options-matter/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/when-options-matter/zh-CN.md` | 21 | 1202 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/when-players-cannot-meet/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/when-players-cannot-meet/zh-CN.md` | 22 | 1298 | 1 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/when-players-run-the-system/en.md` | 0 | 0 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
| `original-articles/when-players-run-the-system/zh-CN.md` | 22 | 1335 | 0 | 原创双语阅读：直接打开，不以项目或练习提交为前提 |
...
| `design-library/second-price-auction/zh-CN.md` line 38 | 单句 112 个汉字；并列项较多（10） | 原书讨论次高价拍卖与真实估值策略。若额外假设单件物品价值固定，玩家只在意自己的物品价值减付款，钱每少1枚恰好损失1分，没有后续费用、组合、对手得物影响或预算障碍，且该价值能用合法报价表达，那么报价达到自身价值，可以避免为了压价而错过低于该价… |
| `reading-search/library.json` $.documents[80].passages[19].text | 单句 112 个汉字；并列项较多（10） | 原书讨论次高价拍卖与真实估值策略。若额外假设单件物品价值固定，玩家只在意自己的物品价值减付款，钱每少1枚恰好损失1分，没有后续费用、组合、对手得物影响或预算障碍，且该价值能用合法报价表达，那么报价达到自身价值，可以避免为了压价而错过低于该价… |
