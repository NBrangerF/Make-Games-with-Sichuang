...
- 机器规则标出了 925 个可能需要分段或渐进披露的长句、长段与抽象词密集处。这是编辑优先级，不是内容质量评分。
...
| `reading-search/articles.json` | 840 | 54268 | 37 | 支持资料：通过节点或资料库按需进入 |
| `reading-search/cases.json` | 788 | 43452 | 65 | 支持资料：通过节点或资料库按需进入 |
