...
- [资源库扩展施工计划](../plans/luozhuo-library-expansion-2026-09-08.md)：规划已完成；后续批次已实现六篇真实游戏双语分析。24个核心主题、48个候选主题及跨机制比较仍待执行，首个里程碑未全部完成。
- [系统阅读3.0：从一局游戏到可交接的草稿](product/TEXT_DRIVEN_LEARNING_PATH.md)：28章主线与13篇选读，每篇中文和英文；同一过河案例贯穿。已接入28处可选练习、14种正式工具和6篇双语案例，并更新阅读视觉。课程入口与导航以本文件为准，早期任务与来源导读方案保留作历史。
