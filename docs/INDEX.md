...
- [机制、主题与案例现行计划](../plans/luozhuo-concrete-library-program-2026-09-10.md)：C01–C09 完成，96 篇库文章与 18 款多角度案例，含全文搜索、教学顺序和阅读恢复。
- [扩展验收](handovers/2026-09-11-library-acceptance.md)：具体交付、逐稿审核、关系修订、浏览器验证与尚未进行的真人测试。
- [内容维护指南](handovers/2026-09-11-library-maintenance.md)：从本地启动到双语写作、证据复用、关系/索引更新、验证、发布与回退。
- [资源库扩展原始计划](../plans/luozhuo-library-expansion-2026-09-08.md)：保留 L01–L10 范围与来源候选；现行路由、交付数量和状态以 9 月 10 日接续计划为准。
- [系统阅读3.0：从一局游戏到可交接的草稿](product/TEXT_DRIVEN_LEARNING_PATH.md)：28章主线与13篇选读，每篇中文和英文；同一过河案例贯穿。已接入28处可选练习、14种正式工具；案例现已扩充为18篇双语分析，并更新阅读视觉。课程入口与导航以本文件为准，早期任务与来源导读方案保留作历史。
- [双语资源网站：项目审查与内容工程计划](../plans/luozhuo-bilingual-resource-program-2026-09-06.md)：基于最新阅读优先目标、关联对话与本地资产审查的待讨论方案；覆盖十四本新增资料、原创综合、双语与阅读支持、发布隔离、工具选择、费用控制和三组样稿试点。
