...
const order = ['carcassonne', 'pandemic', 'dominion', 'six-nimmt', 'hanabi', 'wingspan', 'agricola', 'cant-stop', 'for-sale', 'el-grande', 'quacks', 'ticket-to-ride', 'modern-art', 'the-crew', 'azul']
