...
export const courseUnitsV3: CourseUnitV3[] = [
  ...
  { id: 'unit-03', number: '03', title: '有意义的选择', question: '选项为什么不会立刻坍缩成唯一答案？', output: '决定与信息表', status: 'available', activityId: 'decision-table', activityRevision: '1', toolLabel: '决定表', conciseConcept: '一个选择需要至少两个可考虑选项、不同后果与当下不完整的信息。', example: '现在得 2 分，或保留卡争取下轮 5 分。', counterexample: '一个选项同时更便宜、得分更高且没有风险。', rubric: ['选项后果不同', '代价在当下可感知', '记录玩家决定时知道什么'] },
